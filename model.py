...
def find_frames(theta):
    ...
    frame_01 = revolute_joint(theta[0], 2, 0, pi/2)
    frame_12 = revolute_joint(theta[1], 0, 4, 0)
    frame_23 = revolute_joint(theta[2], 0, 3, 0)
    frame_34 = revolute_joint(theta[3], 0, 2, 0)
